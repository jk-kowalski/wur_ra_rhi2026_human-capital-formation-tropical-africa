...
UNION ALL
SELECT 19  AS country_id, 'liberia',      t.* FROM public.geom_edu_birthplace_19liberia t
UNION ALL
SELECT 20  AS country_id, 'cameroon',     t.* FROM public.geom_edu_birthplace_20cameroon t
UNION ALL
SELECT 21  AS country_id, 'south_sudan',  t.* FROM public.geom_edu_birthplace_21southsudan t
UNION ALL
SELECT 22  AS country_id, 'sudan',        t.* FROM public.geom_edu_birthplace_22sudan t
UNION ALL
SELECT 23  AS country_id, 'zimbabwe',     t.* FROM public.geom_edu_birthplace_23zimbabwe t;
...
UNION ALL
SELECT 19  AS country_id, 'liberia',      t.* FROM public.geom_edu_residence_19liberia t
UNION ALL
SELECT 20  AS country_id, 'cameroon',     t.* FROM public.geom_edu_residence_20cameroon t
UNION ALL
SELECT 21  AS country_id, 'south_sudan',  t.* FROM public.geom_edu_residence_21southsudan t
UNION ALL
SELECT 22  AS country_id, 'sudan',        t.* FROM public.geom_edu_residence_22sudan t
UNION ALL
SELECT 23  AS country_id, 'zimbabwe',     t.* FROM public.geom_edu_residence_23zimbabwe t;
------------------
-- ##########################################################
-- # 4. Output as one shapefile
-- ##########################################################

-- birthplace
DROP VIEW IF EXISTS public.geom_edu_birthplace_all;
...
FROM (
    ...
    --UNION ALL
    -- Ethiopia excluded: birthplace table does not exist
    ...
    UNION ALL
    SELECT 19, 'liberia', t.* FROM public.geom_edu_birthplace_19liberia t
    UNION ALL
    SELECT 20, 'cameroon', t.* FROM public.geom_edu_birthplace_20cameroon t
    UNION ALL
    SELECT 21, 'south_sudan', t.* FROM public.geom_edu_birthplace_21southsudan t
    UNION ALL
    SELECT 22, 'sudan', t.* FROM public.geom_edu_birthplace_22sudan t
    UNION ALL
    SELECT 23, 'zimbabwe', t.* FROM public.geom_edu_birthplace_23zimbabwe t
) x;
...
-- Residence
DROP VIEW IF EXISTS public.geom_edu_residence_all;
...
FROM (
    ...
    UNION ALL
    SELECT 19, 'liberia', t.* FROM public.geom_edu_residence_19liberia t
    UNION ALL
    SELECT 20, 'cameroon', t.* FROM public.geom_edu_residence_20cameroon t
    UNION ALL
    SELECT 21, 'south_sudan', t.* FROM public.geom_edu_residence_21southsudan t
    UNION ALL
    SELECT 22, 'sudan', t.* FROM public.geom_edu_residence_22sudan t
    UNION ALL
    SELECT 23, 'zimbabwe', t.* FROM public.geom_edu_residence_23zimbabwe t
) x;
